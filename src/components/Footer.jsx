...
const Footer = () => {
  return (
    <footer className="bg-[#E3EBF3]  shadow-sm mt-15">
      <div className="max-w-screen-xl mx-auto px-4 py-6 md:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <nav aria-label="Footer Navigation">
            <ul className="flex flex-wrap items-center text-sm text-gray-600 font-medium space-x-4 md:space-x-6 hover:text-[#2A4D69]">
              <li>
        ...
        <hr className="my-6 border-1 border-[#2A4D69] " />

        {/* Copyright */}
        <p className="text-sm text-[#2A4D69]  text-center">
          © 2025{" "}
          <a
