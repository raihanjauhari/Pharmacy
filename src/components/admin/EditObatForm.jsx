...
export default function EditObatForm({ onClose }) {
  ...
  const handleChange = (e) => {
    ...
    // Cegah input negatif untuk harga_satuan dan stok
    if ((name === "harga_satuan" || name === "stok") && Number(value) < 0) {
      return; // abaikan input negatif
    }
  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2 text-center mt-2">
        <button
          type="submit"
          className="bg-green-600 text-white hover:bg-green-700 px-6 py-3 rounded-lg text-sm font-medium shadow-lg"
